...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Product::with(['category', 'subcategory', 'address', 'created_by'])->select(sprintf('%s.*', (new Product)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'image', 'category', 'subcategory', 'featured']);
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('categories', 'subcategories', 'addresses'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $product->load('category', 'subcategory', 'address', 'created_by');

        return view('admin.products.edit', compact('categories', 'subcategories', 'addresses', 'product'));
    }
    ...
    public function show(Product $product)
    {
        ...
        $product->load('category', 'subcategory', 'address', 'created_by', 'productFeaturedProducts');
